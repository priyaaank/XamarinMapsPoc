...
namespace Android.Gms.Games.LeaderBoard {
	...
	public partial interface ILeaderboardScore : global::Android.Gms.Common.Data.IFreezable {
		...
		string DisplayRank {
			[Register ("getDisplayRank", "()Ljava/lang/String;", "GetGetDisplayRankHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		string DisplayScore {
			[Register ("getDisplayScore", "()Ljava/lang/String;", "GetGetDisplayScoreHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		long Rank {
			[Register ("getRank", "()J", "GetGetRankHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		long RawScore {
			[Register ("getRawScore", "()J", "GetGetRawScoreHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Gms.Games.IPlayer ScoreHolder {
			[Register ("getScoreHolder", "()Lcom/google/android/gms/games/Player;", "GetGetScoreHolderHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		string ScoreHolderDisplayName {
			[Register ("getScoreHolderDisplayName", "()Ljava/lang/String;", "GetGetScoreHolderDisplayNameHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Net.Uri ScoreHolderHiResImageUri {
			[Register ("getScoreHolderHiResImageUri", "()Landroid/net/Uri;", "GetGetScoreHolderHiResImageUriHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Net.Uri ScoreHolderIconImageUri {
			[Register ("getScoreHolderIconImageUri", "()Landroid/net/Uri;", "GetGetScoreHolderIconImageUriHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		long TimestampMillis {
			[Register ("getTimestampMillis", "()J", "GetGetTimestampMillisHandler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("getDisplayRank", "(Landroid/database/CharArrayBuffer;)V", "GetGetDisplayRank_Landroid_database_CharArrayBuffer_Handler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")]
		void GetDisplayRank (global::Android.Database.CharArrayBuffer p0);

		[Register ("getDisplayScore", "(Landroid/database/CharArrayBuffer;)V", "GetGetDisplayScore_Landroid_database_CharArrayBuffer_Handler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")]
		void GetDisplayScore (global::Android.Database.CharArrayBuffer p0);

		[Register ("getScoreHolderDisplayName", "(Landroid/database/CharArrayBuffer;)V", "GetGetScoreHolderDisplayName_Landroid_database_CharArrayBuffer_Handler:Android.Gms.Games.LeaderBoard.ILeaderboardScoreInvoker, GooglePlayServicesForReal")]
