...
namespace Com.Google.Android.Gms.Games.Multiplayer.Realtime {
	...
	public partial interface IRoom : global::Android.OS.IParcelable, global::Android.Gms.Common.Data.IFreezable, global::Android.Gms.Games.MultiPlayer.IParticipatable {
		...
		global::Android.OS.Bundle AutoMatchCriteria {
			[Register ("getAutoMatchCriteria", "()Landroid/os/Bundle;", "GetGetAutoMatchCriteriaHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		long CreationTimestamp {
			[Register ("getCreationTimestamp", "()J", "GetGetCreationTimestampHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		string CreatorId {
			[Register ("getCreatorId", "()Ljava/lang/String;", "GetGetCreatorIdHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		string Description {
			[Register ("getDescription", "()Ljava/lang/String;", "GetGetDescriptionHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		global::System.Collections.Generic.IList<string> ParticipantIds {
			[Register ("getParticipantIds", "()Ljava/util/ArrayList;", "GetGetParticipantIdsHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		string RoomId {
			[Register ("getRoomId", "()Ljava/lang/String;", "GetGetRoomIdHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		int Status {
			[Register ("getStatus", "()I", "GetGetStatusHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		int Variant {
			[Register ("getVariant", "()I", "GetGetVariantHandler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("getDescription", "(Landroid/database/CharArrayBuffer;)V", "GetGetDescription_Landroid_database_CharArrayBuffer_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")]
		void GetDescription (global::Android.Database.CharArrayBuffer p0);

		[Register ("getParticipantId", "(Ljava/lang/String;)Ljava/lang/String;", "GetGetParticipantId_Ljava_lang_String_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")]
		string GetParticipantId (string p0);

		[Register ("getParticipantStatus", "(Ljava/lang/String;)I", "GetGetParticipantStatus_Ljava_lang_String_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomInvoker, GooglePlayServicesForReal")]
