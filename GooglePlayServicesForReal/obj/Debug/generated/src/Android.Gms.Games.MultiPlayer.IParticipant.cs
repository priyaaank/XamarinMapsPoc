...
namespace Android.Gms.Games.MultiPlayer {
	...
	public partial interface IParticipant : global::Android.OS.IParcelable, global::Android.Gms.Common.Data.IFreezable {
		...
		string ClientAddress {
			[Register ("getClientAddress", "()Ljava/lang/String;", "GetGetClientAddressHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		string DisplayName {
			[Register ("getDisplayName", "()Ljava/lang/String;", "GetGetDisplayNameHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Net.Uri HiResImageUri {
			[Register ("getHiResImageUri", "()Landroid/net/Uri;", "GetGetHiResImageUriHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Net.Uri IconImageUri {
			[Register ("getIconImageUri", "()Landroid/net/Uri;", "GetGetIconImageUriHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		bool IsConnectedToRoom {
			[Register ("isConnectedToRoom", "()Z", "GetIsConnectedToRoomHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		string ParticipantId {
			[Register ("getParticipantId", "()Ljava/lang/String;", "GetGetParticipantIdHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Gms.Games.IPlayer Player {
			[Register ("getPlayer", "()Lcom/google/android/gms/games/Player;", "GetGetPlayerHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		int Status {
			[Register ("getStatus", "()I", "GetGetStatusHandler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("getDisplayName", "(Landroid/database/CharArrayBuffer;)V", "GetGetDisplayName_Landroid_database_CharArrayBuffer_Handler:Android.Gms.Games.MultiPlayer.IParticipantInvoker, GooglePlayServicesForReal")]
