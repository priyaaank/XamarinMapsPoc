...
namespace Android.Gms.Games {
	...
	public partial interface IRealTimeSocket : IJavaObject {
		...
		global::System.IO.Stream InputStream {
			[Register ("getInputStream", "()Ljava/io/InputStream;", "GetGetInputStreamHandler:Android.Gms.Games.IRealTimeSocketInvoker, GooglePlayServicesForReal")] get;
		}

		bool IsClosed {
			[Register ("isClosed", "()Z", "GetIsClosedHandler:Android.Gms.Games.IRealTimeSocketInvoker, GooglePlayServicesForReal")] get;
		}

		global::System.IO.Stream OutputStream {
			[Register ("getOutputStream", "()Ljava/io/OutputStream;", "GetGetOutputStreamHandler:Android.Gms.Games.IRealTimeSocketInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.OS.ParcelFileDescriptor ParcelFileDescriptor {
			[Register ("getParcelFileDescriptor", "()Landroid/os/ParcelFileDescriptor;", "GetGetParcelFileDescriptorHandler:Android.Gms.Games.IRealTimeSocketInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("close", "()V", "GetCloseHandler:Android.Gms.Games.IRealTimeSocketInvoker, GooglePlayServicesForReal")]
		void Close ();
