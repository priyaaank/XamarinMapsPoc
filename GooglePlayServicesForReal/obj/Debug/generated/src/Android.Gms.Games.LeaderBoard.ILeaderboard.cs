...
namespace Android.Gms.Games.LeaderBoard {
	...
	public partial interface ILeaderboard : IJavaObject {
		...
		string DisplayName {
			[Register ("getDisplayName", "()Ljava/lang/String;", "GetGetDisplayNameHandler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")] get;
		}

		global::Android.Net.Uri IconImageUri {
			[Register ("getIconImageUri", "()Landroid/net/Uri;", "GetGetIconImageUriHandler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")] get;
		}

		string LeaderboardId {
			[Register ("getLeaderboardId", "()Ljava/lang/String;", "GetGetLeaderboardIdHandler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")] get;
		}

		int ScoreOrder {
			[Register ("getScoreOrder", "()I", "GetGetScoreOrderHandler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")] get;
		}

		global::System.Collections.Generic.IList<global::Android.Gms.Games.LeaderBoard.ILeaderboardVariant> Variants {
			[Register ("getVariants", "()Ljava/util/ArrayList;", "GetGetVariantsHandler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("getDisplayName", "(Landroid/database/CharArrayBuffer;)V", "GetGetDisplayName_Landroid_database_CharArrayBuffer_Handler:Android.Gms.Games.LeaderBoard.ILeaderboardInvoker, GooglePlayServicesForReal")]
