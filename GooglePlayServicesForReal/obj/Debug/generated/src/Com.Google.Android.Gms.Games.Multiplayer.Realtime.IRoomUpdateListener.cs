...
namespace Com.Google.Android.Gms.Games.Multiplayer.Realtime {
	...
	public partial interface IRoomUpdateListener : IJavaObject {
		...
		[Register ("onJoinedRoom", "(ILcom/google/android/gms/games/multiplayer/realtime/Room;)V", "GetOnJoinedRoom_ILcom_google_android_gms_games_multiplayer_realtime_Room_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomUpdateListenerInvoker, GooglePlayServicesForReal")]
		void OnJoinedRoom (int p0, global::Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoom p1);

		[Register ("onLeftRoom", "(ILjava/lang/String;)V", "GetOnLeftRoom_ILjava_lang_String_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomUpdateListenerInvoker, GooglePlayServicesForReal")]
		void OnLeftRoom (int p0, string p1);

		[Register ("onRoomConnected", "(ILcom/google/android/gms/games/multiplayer/realtime/Room;)V", "GetOnRoomConnected_ILcom_google_android_gms_games_multiplayer_realtime_Room_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomUpdateListenerInvoker, GooglePlayServicesForReal")]
		void OnRoomConnected (int p0, global::Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoom p1);

		[Register ("onRoomCreated", "(ILcom/google/android/gms/games/multiplayer/realtime/Room;)V", "GetOnRoomCreated_ILcom_google_android_gms_games_multiplayer_realtime_Room_Handler:Com.Google.Android.Gms.Games.Multiplayer.Realtime.IRoomUpdateListenerInvoker, GooglePlayServicesForReal")]
