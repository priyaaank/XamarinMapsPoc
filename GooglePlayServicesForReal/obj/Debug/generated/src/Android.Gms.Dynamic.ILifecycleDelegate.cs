...
namespace Android.Gms.Dynamic {
	...
	public partial interface ILifecycleDelegate : IJavaObject {
		...
		[Register ("onCreate", "(Landroid/os/Bundle;)V", "GetOnCreate_Landroid_os_Bundle_Handler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnCreate (global::Android.OS.Bundle p0);

		[Register ("onCreateView", "(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;", "GetOnCreateView_Landroid_view_LayoutInflater_Landroid_view_ViewGroup_Landroid_os_Bundle_Handler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		...
		[Register ("onDestroy", "()V", "GetOnDestroyHandler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnDestroy ();

		[Register ("onDestroyView", "()V", "GetOnDestroyViewHandler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnDestroyView ();

		[Register ("onInflate", "(Landroid/app/Activity;Landroid/os/Bundle;Landroid/os/Bundle;)V", "GetOnInflate_Landroid_app_Activity_Landroid_os_Bundle_Landroid_os_Bundle_Handler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnInflate (global::Android.App.Activity p0, global::Android.OS.Bundle p1, global::Android.OS.Bundle p2);

		[Register ("onLowMemory", "()V", "GetOnLowMemoryHandler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnLowMemory ();

		[Register ("onPause", "()V", "GetOnPauseHandler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnPause ();

		[Register ("onResume", "()V", "GetOnResumeHandler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
		void OnResume ();

		[Register ("onSaveInstanceState", "(Landroid/os/Bundle;)V", "GetOnSaveInstanceState_Landroid_os_Bundle_Handler:Android.Gms.Dynamic.ILifecycleDelegateInvoker, GooglePlayServicesForReal")]
...
#pragma warning disable 0169
		...
		{
			global::Android.Gms.Dynamic.ILifecycleDelegate __this = global::Java.Lang.Object.GetObject<global::Android.Gms.Dynamic.ILifecycleDelegate> (native__this, JniHandleOwnership.DoNotTransfer);
