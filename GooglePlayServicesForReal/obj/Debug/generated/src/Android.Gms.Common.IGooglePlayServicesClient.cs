...
namespace Android.Gms.Common {
	...
	public partial interface IGooglePlayServicesClientConnectionCallbacks : IJavaObject {
		...
		[Register ("onConnected", "(Landroid/os/Bundle;)V", "GetOnConnected_Landroid_os_Bundle_Handler:Android.Gms.Common.IGooglePlayServicesClientConnectionCallbacksInvoker, GooglePlayServicesForReal")]
		void OnConnected (global::Android.OS.Bundle p0);

		[Register ("onDisconnected", "()V", "GetOnDisconnectedHandler:Android.Gms.Common.IGooglePlayServicesClientConnectionCallbacksInvoker, GooglePlayServicesForReal")]
		void OnDisconnected ();
...
#pragma warning restore 0169
	...
	public partial interface IGooglePlayServicesClientOnConnectionFailedListener : IJavaObject {
		...
		[Register ("onConnectionFailed", "(Lcom/google/android/gms/common/ConnectionResult;)V", "GetOnConnectionFailed_Lcom_google_android_gms_common_ConnectionResult_Handler:Android.Gms.Common.IGooglePlayServicesClientOnConnectionFailedListenerInvoker, GooglePlayServicesForReal")]
...
#pragma warning restore 0649
	...
	public partial interface IGooglePlayServicesClient : IJavaObject {
		...
		bool IsConnected {
			[Register ("isConnected", "()Z", "GetIsConnectedHandler:Android.Gms.Common.IGooglePlayServicesClientInvoker, GooglePlayServicesForReal")] get;
		}

		bool IsConnecting {
			[Register ("isConnecting", "()Z", "GetIsConnectingHandler:Android.Gms.Common.IGooglePlayServicesClientInvoker, GooglePlayServicesForReal")] get;
		}

		[Register ("connect", "()V", "GetConnectHandler:Android.Gms.Common.IGooglePlayServicesClientInvoker, GooglePlayServicesForReal")]
		void Connect ();

		[Register ("disconnect", "()V", "GetDisconnectHandler:Android.Gms.Common.IGooglePlayServicesClientInvoker, GooglePlayServicesForReal")]
		void Disconnect ();

		[Register ("isConnectionCallbacksRegistered", "(Lcom/google/android/gms/common/GooglePlayServicesClient$ConnectionCallbacks;)Z", "GetIsConnectionCallbacksRegistered_Lcom_google_android_gms_common_GooglePlayServicesClient_ConnectionCallbacks_Handler:Android.Gms.Common.IGooglePlayServicesClientInvoker, GooglePlayServicesForReal")]
