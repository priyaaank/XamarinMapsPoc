...
namespace Android.Gms.AppStates {
	...
	public partial interface IOnStateLoadedListener : IJavaObject {
		...
		[Register ("onStateConflict", "(ILjava/lang/String;[B[B)V", "GetOnStateConflict_ILjava_lang_String_arrayBarrayBHandler:Android.Gms.AppStates.IOnStateLoadedListenerInvoker, GooglePlayServicesForReal")]
		void OnStateConflict (int p0, string p1, byte[] p2, byte[] p3);

		[Register ("onStateLoaded", "(II[B)V", "GetOnStateLoaded_IIarrayBHandler:Android.Gms.AppStates.IOnStateLoadedListenerInvoker, GooglePlayServicesForReal")]
