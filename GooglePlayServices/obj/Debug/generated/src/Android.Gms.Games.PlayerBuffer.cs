...
namespace Android.Gms.Games {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.android.gms.games']/class[@name='PlayerBuffer']"
	...
	public sealed partial class PlayerBuffer : global::Android.Gms.Common.Data.DataBuffer {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.gms.games']/class[@name='PlayerBuffer']/method[@name='get' and count(parameter)=1 and parameter[1][@type='int']]"
